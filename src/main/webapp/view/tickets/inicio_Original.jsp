...
<body>
	...
	if(id!=null){
		...
		//con.destruir(); ==>> Para cerrar la BD
	}
	%>
    ...
    <div class="d-flex flex-wrap justify-content-center mb-4">
        <!-- orador 1 -->
        <div class="card mx-1 animate__animated animate__zoomIn animate__delay-1s" style="width: 18rem;">
            <img src="imagenes/steve.png" class="card-img-top" alt="Jobs">
            <div class="card-body">
                <div class="botones mt-2 mb-1">
                    <a href="#" class="btn btn-sm bg-warning">JavaScript</a>
                    <a href="#" class="btn btn-sm bg-primary text-light">React</a>
                </div>

                <div class="dataOradores">
                    <h5 class="card-title">Steve Jobs</h5>
                    <p class="card-text lh-lg">Lorem ipsum dolor sit amet consectetur adipisicing
                        elit. Sapiente porro
                        reprehenderit
                        voluptatum aut. Ducimus non adipisci atque sint, fugiat dolore eum tempora tempore! Atque
                        asperiores,
                        nam consequuntur amet fugit accusamus?</p>
                </div>
            </div>
        </div>
        <!-- orador 2 -->
        <div class="card mx-1 animate__animated animate__zoomIn animate__delay-2s" style="width: 18rem;">
            <img src="imagenes/bill.png" class="card-img-top" alt="Bill">
            <div class="card-body">
                <div class="botones mt-2 mb-1">
                    <a href="#" class="btn btn-sm bg-warning">JavaScript</a>
                    <a href="#" class="btn btn-sm bg-primary text-light">React</a>
        ...
        <!-- orador 3 -->
        <div class="card mx-1 animate__animated animate__zoomIn animate__delay-3s" style="width: 18rem;">
            <img src="imagenes/ada.png" class="card-img-top" alt="Ada">
            <div class="card-body">
                <div class="botones mt-2 mb-1">
                    <a href="#" class="btn btn-sm bg-secondary text-light">Negocios</a>
                    <a href="#" class="btn btn-sm bg-danger text-light">Startups</a>
                </div>
                <div class="dataOradores">
                    <h5 class="card-title">Ada Lovelace</h5>
                    <p class="card-text lh-lg">Lorem ipsum dolor sit amet consectetur adipisicing
                        elit. Sapiente porro reprehenderit
                        voluptatum aut. Ducimus non adipisci atque sint, fugiat dolore eum tempora tempore! Atque
                        asperiores,
                        nam consequuntur amet fugit accusamus?</p>
                </div>
